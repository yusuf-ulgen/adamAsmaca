...
public class WordService {
    ...
    public WordResponse getRandomWord(String difficulty, String category) {
        ...
        if (word == null) {
            return new WordResponse("ADAM ASMACA", "MEDIUM", "GENEL", "İpucu bulunamadı.");
        }

        return new WordResponse(word.getContent(), word.getDifficulty(), word.getCategory() != null ? word.getCategory() : "GENEL", word.getMeaning());
    }
}
